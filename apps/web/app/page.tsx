    ...
    <main className="flex-1 bg-gradient-brand-subtle">
      <section className="mx-auto max-w-6xl px-6 pt-12 pb-12">
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-3">
              <h1 className="text-4xl md:text-5xl font-semibold tracking-tight leading-[1.1] pb-1">
        ...
        <div className="mt-16 space-y-12">
          {skills.length > 0 ? (
            <div className="grid gap-6 md:grid-cols-2 lg:[grid-template-columns:repeat(auto-fit,minmax(340px,1fr))]">
              {skills.map((skill) => (
                <Card 
                  key={skill.id} 
